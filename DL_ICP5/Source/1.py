...
data['text'] = data['text'].apply((lambda x: re.sub('[^a-zA-z0-9\s]', '', x))) # Regex

print(data[data['sentiment'] == 'Positive'].size, '-- Positive Sentiments')
print(data[data['sentiment'] == 'Negative'].size, '-- Negative Sentiments')
...
print("{}: {}".format(loadedModel.metrics_names[1], score[1] * 100))
